...
function SidebarProvider({
  ...
  const [openMobile, setOpenMobile]
    = React.useState(false); // This is the internal state of the sidebar.
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          [
            'fixed inset-y-0 z-10 hidden h-svh  bg-sidebar',
            'w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex',
          ].join(' '),
          side === 'left'
...
function SidebarRail({ className, ...props }: React.ComponentProps<'button'>) {
  ...
  return (
    <button
      ...
      className={cn(
        [
          'hover:after:bg-sidebar-border absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2',
          'transition-all ease-linear group-data-[side=left]:',
          '-right-4 group-data-[side=right]:left-0',
    ...
    <Comp
      ...
      className={cn(
        [
          ...
          'hover:text-sidebar-accent-foreground absolute',
          'top-3.5 right-3 flex aspect-square w-5',
    ...
    <Comp
      ...
      className={cn(
        [
          ...
          'absolute top-1.5 right-1 flex aspect-square',
          'w-5 items-center justify-center rounded-md p-0',
    ...
    <div
      ...
      className={cn(
        [
          ...
          'items-center justify-center rounded-md px-1',
