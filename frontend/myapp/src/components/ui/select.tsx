...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        [
          'border-input data-[placeholder]:text-muted-foreground cursor-pointer ',
          '[&_svg:not([class*=\'text-\'])]:text-muted-foreground',
          'focus-visible:border-ring focus-visible:ring-gray-400',
          ' aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 ',
          'aria-invalid:border-destructive dark:bg-input/30 ',
          'dark:hover:bg-input/50 flex w-fit items-center justify-between gap-2 ',
          ...
          'disabled:opacity-50 data-[size=default]:h-9 ',
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          'bg-white text-popover-foreground data-[state=open]:animate-in cursor-pointer ',
          'data-[state=closed]:animate-out data-[state=closed]:fade-out-0',
          'data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95',
          'data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 ',
          'data-[side=left]:slide-in-from-right-2 ',
          'data-[side=right]:slide-in-from-left-2 ',
          'data-[side=top]:slide-in-from-bottom-2 relative z-[100] ',
    ...
    <SelectPrimitive.Item
      ...
      className={cn(
        [
          ...
          'flex w-full cursor-default items-center gap-2 rounded-sm ',
