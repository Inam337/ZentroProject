    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          'data-[state=open]:animate-in cursor-pointer ',
          'data-[state=closed]:animate-out data-[state=closed]:fade-out-0',
          'data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95',
          'data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 ',
          'data-[side=left]:slide-in-from-right-2 text-black',
          'data-[side=right]:slide-in-from-left-2 ',
          'data-[side=top]:slide-in-from-bottom-2 relative z-60 ',
          'max-h-(--radix-select-content-available-height) min-w-[8rem]',
          'origin-(--radix-select-content-transform-origin) overflow-x-hidden',
          'overflow-y-auto rounded-md border border-gray-300 shadow-md',
          position === 'popper'
    ...
    <SelectPrimitive.Item
      ...
      className={cn(
        [
          ...
          'py-1.5 pr-8 pl-2 text-sm outline-hidden select-none text-black ',
          'text-foreground',
