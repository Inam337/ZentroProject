...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        [
          'focus:bg-accent focus:text-accent-foreground bg-white',
          'relative flex cursor-default items-center gap-2',
          'rounded-sm py-1.5 pr-2 pl-8 text-sm outline-hidden',
          'select-none data-[disabled]:pointer-events-none',
    ...
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        [
          ...
          'data-[state=open]:text-accent-foreground flex',
          'cursor-default items-center rounded-sm px-2 py-1.5',
          'text-sm outline-hidden select-none data-[inset]:pl-8',
        ].join(' '),
        className,
      )}
      {...props}
